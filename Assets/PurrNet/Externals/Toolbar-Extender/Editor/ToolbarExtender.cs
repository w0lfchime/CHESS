...
namespace UnityToolbarExtender
{
	...
	public static class ToolbarExtender
	{
		...
		public static void RequestToolbarRepaint()
		{
			try
			{
				// UnityEditor.Toolbar.get.Repaint();
				var toolbar =typeof(Editor).Assembly.GetType("UnityEditor.Toolbar");
				if (toolbar != null)
				{
					var repaintMethod = toolbar.GetField("get", BindingFlags.Public | BindingFlags.Static);
					if (repaintMethod != null)
					{
						var toolbarInstance = repaintMethod.GetValue(null);
						if (toolbarInstance != null)
						{
							var repaint = toolbarInstance.GetType().GetMethod("Repaint", BindingFlags.Public | BindingFlags.Instance);
							if (repaint != null)
							{
								repaint.Invoke(toolbarInstance, null);
							}
						}
					}
				}
